          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0">
              <div className="bg-white p-4 md:p-4">
                ...
                <div className="flex font-bold gap-2 text-base text-gray-600 flex-wrap">
                  ...
                  <span>›</span>
                  <span className="text-gray-600">{trimText(title, 30)}</span>
                </div>
                    ...
                    <div className="space-y-4">
                      {post.faqs.map((faq, idx) => (
                        <details key={idx} className="group bg-white rounded-xl border border-gray-200 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                          ...
                          <div className="py-4 px-2 pt-2 text-gray-600 leading-relaxed border-t border-gray-100 bg-gray-50/50">
                            {faq.answer.split('\n').map((line, i) => (
            ...
            <div className="lg:w-96 lg:flex-shrink-0 w-full pb-5">
              <div className="bg-white rounded-lg shadow-sm p-3">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Bài viết gần đây</h3>
                <div className="space-y-4">
