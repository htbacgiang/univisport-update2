...
export default function DongPhucYogaPilates({ initialProducts, categoryCounts, categoryArticle }) {
  return <CategoryPageTemplate categorySlug={SLUG} initialProducts={initialProducts} categoryCounts={categoryCounts} ArticleComponent={YogaPilatesUniviPage} categoryArticle={categoryArticle} />;
}

export async function getServerSideProps() {
  try {
    const [initialProducts, categoryCounts, categoryArticle] = await Promise.all([
