                  ...
                  {reviews.map((review, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 max-w-[250px]">
                        {review.comment ? (
                          <p className="text-gray-600 text-xs line-clamp-2 leading-relaxed">{review.comment}</p>
                        ) : (
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-2">
            <button
              ...
              disabled={page === 1}
              className="px-3 py-1.5 rounded-lg border border-gray-200 text-sm text-gray-600 disabled:opacity-40 hover:bg-gray-50 transition-colors"
            >
              Trước
            </button>
