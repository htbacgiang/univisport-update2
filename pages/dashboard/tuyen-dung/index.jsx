                    ...
                    <tr key={job._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button
                          ...
                          className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full cursor-pointer ${job.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                            }`}
                        >
