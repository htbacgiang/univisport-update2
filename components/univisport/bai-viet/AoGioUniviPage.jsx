  ...
  return (
    <div className="text-gray-800">
      <section className="bg-white pb-8">
        <p className="mb-2 text-sm font-semibold text-[#105d97]">Đồng phục thể thao Univi</p>
        ...
        <div className="mt-4 text-base leading-relaxed text-gray-700 space-y-2">
          <p>
      ...
      <Section id="cac-dong-ao-gio" title="3. Các Dòng Đồng Phục Áo Gió Phổ Biến Hiện Nay">
        ...
        <div className="grid gap-6 mt-6">
          <div className="border-l-4 border-[#105d97]/20 py-1 pl-4">
            <h3 className="mb-1 text-base font-bold text-gray-900">3.1 Đồng Phục Áo Gió 1 Lớp</h3>
            ...
            <p className="text-sm leading-relaxed text-gray-700 md:text-base mt-2">
            ...
            <p className="text-sm leading-relaxed text-gray-700 md:text-base mt-2 italic text-gray-500">
          ...
          <div className="border-l-4 border-[#105d97]/20 py-1 pl-4">
            <h3 className="mb-1 text-base font-bold text-gray-900">3.2 Đồng Phục Áo Gió 2 Lớp</h3>
            <p className="text-sm leading-relaxed text-gray-700 md:text-base">
          ...
          <div className="border-l-4 border-[#105d97]/20 py-1 pl-4">
            <h3 className="mb-1 text-base font-bold text-gray-900">3.3 Đồng Phục Áo Gió Siêu Nhẹ</h3>
            <p className="text-sm leading-relaxed text-gray-700 md:text-base">
      ...
      <Section id="nang-luc" title="6. Năng Lực Sản Xuất Đồng Phục Áo Gió Của Univi">
        <div className="space-y-4 leading-relaxed text-sm md:text-base text-gray-700">
          <p>
      ...
      <Section id="bao-gia" title="7. Báo Giá May Đồng Phục Áo Gió Theo Yêu Cầu">
        ...
        <div className="mt-6 space-y-4">
          <h3 className="text-lg font-bold text-gray-900">7.2 Những Yếu Tố Ảnh Hưởng Đến Báo Giá</h3>
