              ...
              <div className="flex items-center justify-between flex-wrap gap-3 px-5 py-3.5 border-t border-[#f1f5f9] bg-[#f8fafc]">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1.5 text-sm font-medium text-[#374151] border border-[#d1d5db] rounded-lg bg-white hover:bg-[#f3f4f6] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                  >
