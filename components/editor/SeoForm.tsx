      ...
      <div>
        ...
        <div>
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#105d97] focus:border-transparent outline-none text-gray-800 bg-gray-50/50 focus:bg-white transition-colors resize-none leading-relaxed text-sm"
